...
var getQueryIdFromPath = function getQueryIdFromPath(path) {
    var event = arguments.length <= 1 || arguments[1] === undefined ? undefined : arguments[1];
...
var unsetWatcher = function unsetWatcher(firebase, dispatch, event, path) {
    ...
    var isSkipClean = arguments.length <= 5 || arguments[5] === undefined ? false : arguments[5];
...
var watchEvent = exports.watchEvent = function watchEvent(firebase, dispatch, event, path) {
    var isListenOnlyOnDelta = arguments.length <= 4 || arguments[4] === undefined ? false : arguments[4];
    var isAggregation = arguments.length <= 5 || arguments[5] === undefined ? false : arguments[5];
            ...
            queryParams.forEach(function (param) {
                ...
                switch (param[0]) {
                    ...
                    case 'limitToLast':
                        ...
                        break;
                    case 'equalTo':
                        var equalToParam = !doNotParse && isIntString(param[1]) ? parseInt(param[1]) : param[1];
                        equalToParam = equalToParam === 'null' ? null : equalToParam;
                        query = param.length === 3 ? query.equalTo(equalToParam, param[2]) : query.equalTo(equalToParam);
                        break;
                    case 'startAt':
                        var startAtParam = !doNotParse && isIntString(param[1]) ? parseInt(param[1]) : param[1];
                        startAtParam = startAtParam === 'null' ? null : startAtParam;
                        query = param.length === 3 ? query.startAt(startAtParam, param[2]) : query.startAt(startAtParam);
                        break;
                    case 'endAt':
                        var endAtParam = !doNotParse && isIntString(param[1]) ? parseInt(param[1]) : param[1];
...
var unWatchEvent = exports.unWatchEvent = function unWatchEvent(firebase, dispatch, event, path) {
    var isSkipClean = arguments.length <= 4 || arguments[4] === undefined ? false : arguments[4];
...
var unWatchEvents = exports.unWatchEvents = function unWatchEvents(firebase, dispatch, events) {
    var isUnmount = arguments.length <= 3 || arguments[3] === undefined ? false : arguments[3];
    return events.forEach(function (event) {
